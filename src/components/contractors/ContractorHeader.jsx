      ...
      <div className="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
        <div className="space-y-1.5">
          ...
          <p className="text-xs text-slate-400 sm:text-sm">
            Track package accountability, contractor execution progress, and trade performance against baseline scope.
          </p>
        </div>
      ...
      <div className="mt-4 grid grid-cols-2 gap-3 border-t border-surface-border/70 pt-4 sm:grid-cols-4">
        ...
        <div className="flex flex-col">
          ...
          <div className="mt-0.5 flex items-center gap-1.5">
            ...
            <span className="font-mono text-xs font-semibold text-slate-200">
              {(responsibilityMeta?.contractors || []).length} Registered EPC / Sub-Contractors
            </span>
          </div>
        </div>
        ...
        <div className="flex flex-col">
          ...
          <div className="mt-1 flex items-center">
            <StatusBadge
              status="onTrack"
              label="Standardized Contracts Active"
              size="sm"
            />
          </div>
        </div>

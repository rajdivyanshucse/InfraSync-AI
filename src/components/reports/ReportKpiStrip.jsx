  ...
  return (
    <div className="grid grid-cols-2 gap-3 sm:grid-cols-3 lg:grid-cols-6">
      ...
      <div
        ...
        className="group cursor-pointer overflow-hidden rounded-xl border border-surface-border bg-surface-card/90 p-3.5 shadow-sm backdrop-blur-sm transition-all hover:border-indigo-500/40 hover:bg-surface-elevated"
      >
        ...
        <div className="mt-2 flex items-baseline gap-1.5">
          ...
          <span className="text-3xs font-mono text-slate-400">P6 Baseline</span>
        </div>
      ...
      <div
        ...
        className="group cursor-pointer overflow-hidden rounded-xl border border-surface-border bg-surface-card/90 p-3.5 shadow-sm backdrop-blur-sm transition-all hover:border-emerald-500/40 hover:bg-surface-elevated"
      >
        <div className="flex items-center justify-between">
          <span className="text-3xs font-bold uppercase tracking-wider text-slate-400">
            Ground Progress
        ...
        <div className="mt-2 flex items-baseline gap-1.5">
          ...
          <span className="text-3xs font-mono text-slate-400">Measured</span>
        </div>
        <div className="mt-1 text-3xs text-slate-400">
      ...
      <div
        onClick={() => onSelectReportType?.('execution')}
        className="group cursor-pointer overflow-hidden rounded-xl border border-surface-border bg-surface-card/90 p-3.5 shadow-sm backdrop-blur-sm transition-all hover:border-sky-500/40 hover:bg-surface-elevated"
      >
        <div className="flex items-center justify-between">
          <span className="text-3xs font-bold uppercase tracking-wider text-slate-400">
            Progress Variance
        ...
        <div className="mt-2 flex items-baseline gap-1.5">
          ...
          <span className="text-3xs font-mono text-slate-400">Delta</span>
        </div>
        <div className="mt-1 text-3xs text-slate-400">
      ...
      <div
        ...
        className="group cursor-pointer overflow-hidden rounded-xl border border-surface-border bg-surface-card/90 p-3.5 shadow-sm backdrop-blur-sm transition-all hover:border-teal-500/40 hover:bg-surface-elevated"
      >
        <div className="flex items-center justify-between">
          <span className="text-3xs font-bold uppercase tracking-wider text-slate-400">
            Evidence Coverage
        ...
        <div className="mt-2 flex items-baseline gap-1.5">
          <span className="font-mono text-xl font-bold tracking-tight text-teal-400 sm:text-2xl">
            {evidenceCoveragePercent}%
          </span>
          <span className="text-3xs font-mono text-slate-400">Linked</span>
        </div>
        <div className="mt-1 text-3xs text-slate-400">
          <span>Field verification availability</span>
        </div>
      </div>
      ...
      <div
        ...
        className="group cursor-pointer overflow-hidden rounded-xl border border-surface-border bg-surface-card/90 p-3.5 shadow-sm backdrop-blur-sm transition-all hover:border-amber-500/40 hover:bg-surface-elevated"
      >
        <div className="flex items-center justify-between">
          <span className="text-3xs font-bold uppercase tracking-wider text-slate-400">
            Early Warnings
      ...
      <div
        ...
        className={`group cursor-pointer overflow-hidden rounded-xl border p-3.5 shadow-sm backdrop-blur-sm transition-all ${
          escalatedInterventionsCount > 0
            ? 'border-rose-500/40 bg-rose-500/10 hover:border-rose-500/60 hover:bg-rose-500/15'
            : 'border-surface-border bg-surface-card/90 hover:border-sky-500/40 hover:bg-surface-elevated'
        }`}
      >
        <div className="flex items-center justify-between">
          <span className="text-3xs font-bold uppercase tracking-wider text-slate-400">
        ...
        <div className="mt-2 flex items-baseline gap-1.5">
          <span
            className={`font-mono text-xl font-bold tracking-tight sm:text-2xl ${
              escalatedInterventionsCount > 0 ? 'text-rose-300 font-extrabold' : 'text-white'
            }`}
          >

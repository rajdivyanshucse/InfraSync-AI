      ...
      <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between border-b border-surface-border pb-3">
        ...
        <div className="flex items-center gap-2 text-xs font-mono text-slate-400">
          ...
          <select
            ...
            className="rounded-lg border border-surface-border bg-surface-subtle px-2 py-1 text-2xs text-slate-200 focus:border-brand-500 focus:outline-none"
          >
            ...
            >
              ...
              <div className="space-y-1">
                <div className="flex items-center justify-between font-mono text-2xs">
                  ...
                  <span className="font-bold text-emerald-400">{cont.actualProgress}%</span>
                </div>
                <Progress
              ...
              <div className="border-t border-surface-border/40 pt-2 flex items-center justify-between text-3xs font-mono">
                ...
                <span className="text-slate-500">Contractor Log</span>
              </div>
            </div>
          );
        })}
